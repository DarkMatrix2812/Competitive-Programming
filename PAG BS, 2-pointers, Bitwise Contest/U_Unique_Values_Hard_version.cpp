...
void solve()
{
    int n;
    cin >> n;
    // we find leftmost and rightmost occurrences in <= 22 queries
    // last occurrence in <= 11 queries?
    int l = 1; int r = 2 * n + 1;
    vector<int> ans;
    int idx1 = 0;
    while (l <= r)
    {
        ...
        int x;
        cin >> x;
        if ((mid - x) % 2 == 1) // 3-peat element present
        {
            idx1 = mid;
            r = mid - 1;
        }
    ...
    while (l <= r)
    {
        ...
        int x;
        cin >> x;
        if ((2 * n + 2 - mid - x) % 2 == 1) // 3-peat element present
        {
            idx2 = mid;
            l = mid + 1;
        }
    ...
    {
        int mid = (l + r) / 2;
        cout << "? " << (idx1 - mid + 2) << " " << idx2 << " ";
        for (int i = mid; i <= idx1; i++)
        {
            cout << i << " ";
        }
        cout << endl;
        int x;
        cin >> x;
        if ((idx1 - mid + 2 - x) % 2 == 1) // 3-peat element present
        {
            idx3 = mid;
            l = mid + 1; 
        }
