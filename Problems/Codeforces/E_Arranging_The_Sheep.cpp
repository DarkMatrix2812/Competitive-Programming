...
void solve()
{
    ...
    if (sz % 2 == 1)
    {
        ...
        int mid = sheep[sz / 2];
        pos.push_back(mid);
        for (int i = mid + 1; i < mid + 1 + sz / 2; i ++)
        {
            pos.push_back(i);
        }
        for (int i = mid - 1; i > mid - 1 - sz / 2; i --)
    ...
    else
    {
        ...
        vector<int> pos1;
        int mid = (sheep[sz / 2] + sheep[sz / 2 - 1]) / 2;
        pos1.push_back(mid);
        for (int i = mid + 1; i < mid + 1 + sz / 2; i ++)
        {
            pos1.push_back(i);
        }
        for (int i = mid - 1; i > mid - sz / 2; i --)
        {
            pos1.push_back(i);
        }
        ...
        for (int i = mid - 1; i > mid - sz / 2 - 1; i --)
        {
            pos2.push_back(i);
        }
