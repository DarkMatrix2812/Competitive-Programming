...
void solve()
{
    ...
    if ((target == 0 && e >= o) || (target == 1 && o >= e))
    {
        ...
        while (turn < n)
        {
            while (l < even.size() && used[even[l]] == true)
            {
                l += 1;
            }
            while (r < odd.size() && used[odd[r]] == true)
            {
                r += 1;
            }
            if (turn % 2 == 0)
