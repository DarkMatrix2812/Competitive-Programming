...
void solve()
{
    ...
    double ans = 2000 * (1 - (1 - (double)((r[n - 1] / p) - (l[n - 1] - 1) / p) / (r[n - 1] - l[n - 1] + 1)) * (1 - (double)((r[0] / p) - (l[0] - 1) / p) / (r[0] - l[0] + 1)));
    for (int i = 0; i < n - 1; i ++)
    {
        ans += 2000 * (1 - (1 - (double)((r[i] / p) - (l[i] - 1) / p) / (r[i] - l[i] + 1)) * (1 - (double)((r[i + 1] / p) - (l[i + 1] - 1) / p) / (r[i + 1] - l[i + 1] + 1)));
    }
