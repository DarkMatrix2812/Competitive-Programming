...
void solve()
{
    ...
    if (!e.empty())
    {
        mne = *min_element(e.begin(), e.end());
        mxe = *max_element(e.begin(), e.end());
    }
    if (!o.empty())
    {
        mno = *min_element(o.begin(), o.end());
        mxo = *max_element(o.begin(), o.end());
    }
    // we need to be able to sort even and odd separately
